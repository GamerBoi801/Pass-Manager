import os, sqlite3, pyfiglet, bcrypt, typer
import secrets, string, getpass
...
if __name__ == '__main__':
    #only checks for db esxisitence
    if not(os.path.exists(DB_PATH)):
        typer.echo("It appears this is the first time running the password manager.")
        typer.echo("Please run the 'first-use' command to set up the application.")
    app()
